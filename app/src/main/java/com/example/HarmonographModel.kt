...
data class HarmonographSettings(
    ...
    fun toLockedSnapshotSettings(): HarmonographSettings {
        return copy(
            ampX = ampX.copy(locked = true, rangeLocked = false),
            ampY = ampY.copy(locked = true, rangeLocked = false),
            ampZ = ampZ.copy(locked = true, rangeLocked = false),
            
            freqX = freqX.copy(locked = true, rangeLocked = false, current = activeFreqX),
            freqY = freqY.copy(locked = true, rangeLocked = false, current = activeFreqY),
            freqZ = freqZ.copy(locked = true, rangeLocked = false, current = activeFreqZ),
            xyzFreqMultiplier = xyzFreqMultiplier.copy(locked = true, rangeLocked = false),
            
            decayX = decayX.copy(locked = true, rangeLocked = false),
            decayY = decayY.copy(locked = true, rangeLocked = false),
            decayZ = decayZ.copy(locked = true, rangeLocked = false),
            
            phaseX = phaseX.copy(locked = true, rangeLocked = false),
            phaseY = phaseY.copy(locked = true, rangeLocked = false),
            phaseZ = phaseZ.copy(locked = true, rangeLocked = false),
            
            phaseSubX = phaseSubX.copy(locked = true, rangeLocked = false),
            phaseSubY = phaseSubY.copy(locked = true, rangeLocked = false),
            phaseSubZ = phaseSubZ.copy(locked = true, rangeLocked = false),
            
            ampSubX = ampSubX.copy(locked = true, rangeLocked = false),
            ampSubY = ampSubY.copy(locked = true, rangeLocked = false),
            ampSubZ = ampSubZ.copy(locked = true, rangeLocked = false),
            
            subXFreqFactor = subXFreqFactor.copy(locked = true, rangeLocked = false, current = kotlin.math.round(activeSubXFreqFactor).toInt()),
            subXFreqIsMultiply = subXFreqIsMultiply.copy(locked = true),
            subYFreqFactor = subYFreqFactor.copy(locked = true, rangeLocked = false, current = kotlin.math.round(activeSubYFreqFactor).toInt()),
            subYFreqIsMultiply = subYFreqIsMultiply.copy(locked = true),
            subZFreqFactor = subZFreqFactor.copy(locked = true, rangeLocked = false, current = kotlin.math.round(activeSubZFreqFactor).toInt()),
            subZFreqIsMultiply = subZFreqIsMultiply.copy(locked = true),
            
            saturation = saturation.copy(locked = true, rangeLocked = false),
            solidColorHue = solidColorHue.copy(locked = true, rangeLocked = false),
            gradientStartHue = gradientStartHue.copy(locked = true, rangeLocked = false),
            gradientEndHue = gradientEndHue.copy(locked = true, rangeLocked = false),
            
            hueShiftSpeed = hueShiftSpeed.copy(locked = true, rangeLocked = false),
            hueShiftRange = hueShiftRange.copy(locked = true, rangeLocked = false),
            hueShiftingEnabled = hueShiftingEnabled.copy(locked = true),
            
            rainbowHue = rainbowHue.copy(locked = true, rangeLocked = false),
            rainbowColorRange = rainbowColorRange.copy(locked = true, rangeLocked = false),
            spicyHue = spicyHue.copy(locked = true, rangeLocked = false),
            spicyColorRange = spicyColorRange.copy(locked = true, rangeLocked = false),
            chromaticShift = chromaticShift.copy(locked = true, rangeLocked = false),
            liveChromaticShiftEnabled = liveChromaticShiftEnabled.copy(locked = true),
            chromaticShiftSpeed = chromaticShiftSpeed.copy(locked = true, rangeLocked = false),
            
            penCount = penCount.copy(locked = true, rangeLocked = false),
            penRotationEnabled = penRotationEnabled.copy(locked = true),
            penRotationMultiplier = penRotationMultiplier.copy(locked = true, rangeLocked = false),
            penRotationIsMultiply = penRotationIsMultiply.copy(locked = true),
            drawSpeedMinutes = drawSpeedMinutes.copy(locked = true, rangeLocked = false),
            
            penOffset = penOffset.copy(locked = true, rangeLocked = false),
            periodicShapeSize = periodicShapeSize.copy(locked = true, rangeLocked = false),
            periodicProgressiveDelay = periodicProgressiveDelay.copy(locked = true, rangeLocked = false),
            periodicShapeFreqFactor = periodicShapeFreqFactor.copy(locked = true, rangeLocked = false),
            lineThickness = lineThickness.copy(locked = true, rangeLocked = false),
            cameraDistance = cameraDistance.copy(locked = true, rangeLocked = false),
            coasterDeviationAngle = coasterDeviationAngle.copy(locked = true, rangeLocked = false),
            coasterOrbitSpeed = coasterOrbitSpeed.copy(locked = true, rangeLocked = false),
            decayEnabled = decayEnabled.copy(locked = true),
            rationalFrequenciesEnabled = rationalFrequenciesEnabled.copy(locked = true),
            gyroSensitivity = gyroSensitivity.copy(locked = true, rangeLocked = false),
            lineAlpha = lineAlpha.copy(locked = true, rangeLocked = false),
            perfVelocityModifier = perfVelocityModifier.copy(locked = true, rangeLocked = false),
            perfAngularModifier = perfAngularModifier.copy(locked = true, rangeLocked = false),
            
            monoScaleEnabled = monoScaleEnabled.copy(locked = true),
            monoScaleShift = monoScaleShift.copy(locked = true, rangeLocked = false),
            monoScaleLiveShiftEnabled = monoScaleLiveShiftEnabled.copy(locked = true),
            monoScaleLiveShiftSpeed = monoScaleLiveShiftSpeed.copy(locked = true, rangeLocked = false)
        )
    }
